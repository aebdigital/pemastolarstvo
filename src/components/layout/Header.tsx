...
export default function Header({ section = "dvere" }: HeaderProps) {
  ...
  const doorLinks = [
    ...
    { href: "/1.pdf", label: "AKCIOVÝ KATALÓG" },
  ];
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-premium ${scrolled ? "bg-white/95 backdrop-blur-xl shadow-premium" : "bg-white"
      ...
      >
        <div className="max-w-[1920px] mx-auto px-8 lg:px-12">
          <div className="flex items-center justify-between h-20 md:h-24">
            ...
            {/* Mobile Toggle */}
            <button
              className="lg:hidden w-12 h-12 bg-dark text-white rounded-2xl flex flex-col items-center justify-center gap-1.5 shadow-xl active:scale-95 transition-premium group"
